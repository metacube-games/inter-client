  ...
  return (
    <>
      <main className="relative flex min-h-screen flex-col items-center justify-between">
        ...
        <section
          id="main-content"
          className="relative z-10 bg-black bg-opacity-80 text-green-400 p-8 rounded-lg border border-green-400 max-w-3xl mx-auto my-12 md:my-24 shadow-lg shadow-green-900/20 w-[95%] md:w-auto"
