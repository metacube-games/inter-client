          ...
          <>
            ...
            <fieldset className="bg-black bg-opacity-50 p-5 rounded-lg">
              ...
              <div className="flex flex-col items-center gap-4 mb-2">
                {!(rewardAddress?.length > 5) && (
                  <div className="bg-amber-800 bg-opacity-70 border border-amber-600 rounded-md p-3 mb-2 text-center">
                    ...
                    <p className="text-white text-sm">
                      Once your wallet is linked, it can not be changed and
                      assets will be sent directly to this address.{" "}
                      <span className="font-bold text-amber-300">
                    ...
                    <p className="text-white text-sm mt-2">
                      Please verify your wallet address carefully before
                      confirming.
                    </p>
                  </div>
                )}
